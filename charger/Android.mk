...
include $(CLEAR_VARS)
LOCAL_SRC_FILES := healthd_board_legion.cpp
LOCAL_MODULE := libhealthd.legion
LOCAL_CFLAGS := -Werror
LOCAL_C_INCLUDES := \
...
include $$(CLEAR_VARS)
LOCAL_MODULE := vendor_legion_charger_$(notdir $(1))
...
include $(CLEAR_VARS)
LOCAL_MODULE := legion_charger_res_images
LOCAL_MODULE_TAGS := optional
